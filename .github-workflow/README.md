...
### docker-compose в даному випадку використовується для оркестрації сервісів, тобто він об'єднує контейнери в одну мережу, а nginx в свою чергу працює як reverse-proxy.Він перенаправляє відповідні HTTP запити всередині Docker мережі
...
### CI/CD в даному випадку використовується для ssh підключення
